...
//};
//
//void polygon(int a, int b, int c, int d, int type)
//{
//	if (type) 	gluBuild2DMipmaps(GL_TEXTURE_2D, 3,
//		width,
//		height,
...
//	data1 = stbi_load("cat.jpg", &width, &height, &nrChannels, 0);
//	data2 = stbi_load("cat2.jpg", &width, &height, &nrChannels, 0);
//}
//
//
